...
function showAbout() {
  ...
  Swal.fire({
    ...
    html: `
        <br/>
        <div id="about">
            <b style="color:blue">project</b> project on
            <a href="https://github.com/Sonali2558/Gmeet-Clone" target="_blank"><br/></br>
            <img alt="Github" src="../images/github.png"></a><br/><br/>
        </div>
        </br>
        <div id="author">Authors : <a href="https://github.com/sumit11899" target="_blank">sumit</a> & <a href="https://github.com/sumit11899" target="_blank">sumit</a></div>`,
    showClass: {
      popup: "animate__animated animate__fadeInDown",
    },
    hideClass: {

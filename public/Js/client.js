...
function showAbout() {
  ...
  Swal.fire({
    ...
    html: `
        <br/>
        <div id="about">
            <b style="color:blue">Gmeet</b> project on
            <a href="https://github.com/sumit11899/Gmeet-project" target="_blank"><br/></br>
            <img alt="Github" src="../images/github.png"></a><br/><br/>
        </div>
        </br>
        <div id="author">Authors : <a href="https://github.com/sumit11899" target="_blank">sumit</a> & <a href="https://github.com/Sakshikumari18" target="_blank">sakshi</a>&<a href="https://github.com/sonali2558" target="_blank">sonali</a></div>`,
    showClass: {
      popup: "animate__animated animate__fadeInDown",
    },
    hideClass: {
